...
public class SearchPanel extends JPanel {
	...
	private void init() {
		...
		toolBarButtons[1] = new IconButton("歌曲音乐库");
		toolBarButtons[1].setText("歌曲音乐库");
		toolBarButtons[2] = new IconButton("歌曲视频");
		toolBarButtons[2].setText("歌曲视频");
		toolBarButtons[3] = new IconButton("歌曲歌词");
		toolBarButtons[3].setText("歌曲歌词");
		toolBarButtons[4] = new IconButton("歌曲广播");
		toolBarButtons[4].setText("歌曲广播");
		toolBarButtons[5] = new IconButton("更多");
		toolBarButtons[5].setText("更多");
